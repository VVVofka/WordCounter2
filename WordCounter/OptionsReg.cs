...
namespace WordCounter {
	class OptionsReg {
		...
		private readonly List<Control> lst = new List<Control>();
		...
		public void setReg(string valName, string obj) {
			Registry.SetValue(keyPath, valName, obj);
		} // ////////////////////////////////////////////////////////////////////////////////////////
		public void setReg(string valName, int obj) {
			Registry.SetValue(keyPath, valName, obj);
		} // ////////////////////////////////////////////////////////////////////////////////////////
		public string getReg(string valName, string defval ="") {
			return Convert.ToString(Registry.GetValue(keyPath, valName, defval));
		} // ////////////////////////////////////////////////////////////////////////////////////////
		public int getRegInt(string valName, int defval =0) {
			return Convert.ToInt32(Registry.GetValue(keyPath, valName, defval));
		} // ////////////////////////////////////////////////////////////////////////////////////////
		public void SaveAll() {
